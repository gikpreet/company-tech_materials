...
+
image:./images/02/01/image07.png[width=500]
+
...
|===
+
image:./images/02/01/image08.png[width=350]
+
4. 아래쪽에서 **만들기** 버튼을 클릭합니다.
5. 생성된 blob 컨테이너를 확인합니다.
+
image:./images/02/01/image09.png[width=600]
...
+
image:./images/02/03/image06.png[width=700]
+
4. 왼쪽 패널에서 **구성**을 클릭합니다.
5. **구성** 페이지에서 설정을 아래와 같이 변경합니다.
+
[cols="1,2a", options="header"]
|===
|항목|값
...
+
image:./images/02/03/image08.png[width=800]
+
7. 오른쪽에서 열리는 **리소스 JSON** 패널에서 **id** 필드의 값을 복사합니다.
+
image:./images/02/03/image09.png[width=700]
...
----
+
image:./images/02/03/image10.png[width=400]
+
...
2. 아래 명령을 수행하여 Bastion Tunneling을 구성합니다. 아래 명령은 배스턴 터널링을 사용하여 dm-cyclecloud 가상 컴퓨터의 443번 포트를 로컬 호스트의 8443번 포트로 포워딩합니다.
+
----
...
+
image:./images/02/03/image11.png[width=500]
+
6. 아래쪽의 x.x.x.x(안전하지 않음)로 이동 링크를 클릭합니다.
+
image:./images/02/03/image12.png[width=500]
+
7. CycleCloud 포털에 연결됩니다.
+
image:./images/02/03/image13.png[width=700]
+
8. 웹 브라우저를 닫습니다.
...
9. 생성된 관리 ID를 확인합니다.
+
image:./images/02/04/image03.png[width=600]
...
+
image:./images/02/04/image06.png[width=680]
+
8. 아래쪽에서 **다음** 버튼을 클릭합니다.
...
+
image:./images/02/04/image08.png[width=500]
+
...
+
image:./images/02/04/image10.png[width=700]
...
8. Subscriptions 페이지에서 위쪽의 **Back to Clusters** 링크를 클릭합니다.
+
image:./images/02/06/image05.png[width=700]
+
9. 클러스터 페이지를 확인합니다.
+
image:./images/02/image06.png[width=700]
