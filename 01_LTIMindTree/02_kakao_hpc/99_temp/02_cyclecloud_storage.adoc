...
+
image:./images/02/image04.png[width=700]
+
14. 생성된 스토리지 계정의 정보를 확인합니다.
+
image:./images/02/image05.png[width=800]
...
+
image:./images/02/image06.png[width=500]
+
...
+
image:./images/02/image07.png[width=600]
...
+
image:./images/02/image08.png[width=400]
+
2. **SSH 키** 페이지에서 왼쪽 위의 **만들기** 를 클릭합니다.
+
image:./images/02/image09.png[width=600]
+
...
|===
+
image:./images/02/image14.png[width=800]
+
5. 아래에서 **다음: 디스크** 버튼을 클릭합니다.
6. 디스크 탭에서, 기본 값들을 유지하고 아래에서 **다음: 네트워킹** 버튼을 클릭합니다.
+
image:./images/02/image15.png[width=800]
+
7. 네트워킹 탭에서, 아래와 같이 가상 머신의 네트워크 정보를 설정합니다. 다른 설정은 기본값으로 유지합니다.
+
[cols="1,3a", options="header"]
|===
|항목|값
...
+
8. 아래에서 **검토 + 만들기** 버튼을 클릭합니다.
9. 유효성 검사가 완료되면, 아래에서 **만들기** 버튼을 클릭합니다.
10. 배포가 시작됩니다.
11. 배포가 완료되면, 리소스로 이동 버튼을 클릭합니다.
...
+
image:./images/02/image17-1.png[width=500]
+
2. 관리 ID 페이지에서 왼쪽 위의 **만들기**를 클릭합니다.
+
image:./images/02/image17-2.png[width=500]
+
...
9. 생성된 관리 ID를 확인합니다.
+
image:./images/02/image17-3.png[width=600]
...
+
image:./images/02/image17-10.png[width=500]
...
4. 위쪽에서 저장 버튼을 클릭합니다.
+
image:./images/02/image19.png[width=800]
+
5. **시스템에 할당한 관리 ID 사용**에서 **예**를 클릭합니다.
+
image:./images/02/image20.png[width=800]
+
6. **Azure 역할 할당** 버튼을 클릭합니다.
+
image:./images/02/image21.png[width=800]
+
7. Azure 역할 할당 페이지에서 **역할 할당 추가**를 클릭합니다.
+
image:./images/02/image22.png[width=800]
+
...
|===
+
image:./images/02/image22-1.png[width=800]
+
...
11. 추가된 역할을 확인합니다.
+
image:./images/02/image22-2.png[width=800]
...
+
image:./images/02/image27.png[width=700]
+
...
|===
+
image:./images/02/image29.png[width=700]
+
12. 아래쪽의 Save 버튼을 클릭합니다.
13. 위쪽의 **Back to Cluster** 링크를 클릭합니다.
+
image:./images/02/image30.png[width=700]
+
14. 클러스터 페이지를 확인합니다.
+
image:./images/02/image31.png[width=700]
